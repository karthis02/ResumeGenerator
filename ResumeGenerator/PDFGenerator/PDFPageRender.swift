...
class PDFPageRender: UIPrintPageRenderer {
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        let attributes = [NSAttributedString.Key.font: customFont, NSAttributedString.Key.foregroundColor: UIColor(red: 205.0/255.0, green: 205.0/255.0, blue: 205.0/255, alpha: 1.0)]
        
        footerText.draw(at: CGPoint(x: centerX, y: centerY), withAttributes: attributes as Any as? [NSAttributedString.Key : Any] )
